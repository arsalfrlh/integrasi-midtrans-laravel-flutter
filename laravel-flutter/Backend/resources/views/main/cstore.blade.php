    ...
    <div class="container">
        ...
        <div class="card" style="width: 40rem;">
            <div class="card-body">
                ...
                @endif
                <form action="/payment/cstore/proses" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="store" class="form-control">
                            <option value="alfamart">Alafamart</option>
                            <option value="indomaret">Indomaret</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Pesan</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Pesan" name="message">
                    </div>
                    <div class="form-group">
                        <input type="hidden" value="cstore" name="payment_type"> <!-- Karena di tampilan ini kshusus bank maka "payment_type" adalah "bank_transfer" isi valuenya harus sesuai dgn method payment -->
