...
class _PaymentBankPageState extends State<PaymentBankPage> {
  ...
  void initState() {
    ...
    vaNumberController = TextEditingController(text: widget.bank.vaNumber);
    waktuTransaksiController = TextEditingController(text: widget.bank.waktuTransaksi);
    expireController = TextEditingController(text: widget.bank.Expired);
