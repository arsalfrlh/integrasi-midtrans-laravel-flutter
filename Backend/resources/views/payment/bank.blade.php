    ...
    <div class="container">
        <div class="card" style="width: 40rem;">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput2">BANK Pembayaran</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" value="{{ $payment['va_numbers']['0']['bank'] }}" readonly> <!-- gunakan ['0']| ['1']| ['2'] jika array key dlm index lagi -->
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput2">Kode Pembayaran</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" value="{{ $payment['va_numbers']['0']['va_number'] }}" readonly>
                </div>
                <div class="form-group">
